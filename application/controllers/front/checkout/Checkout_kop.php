...
class checkout_kop extends CI_Controller {
	...
	public function index() {
        ...
        $this->lib->check_lokasi("Checkout_kop");     
        $this->load->view('front/pages/checkout/checkout_kop');
    }
	public function add() {
        $this->lib->check_session_customer();
        $temp = '0';
        ...
        $error = '';
            ...
            if ($this->form_validation->run() == FALSE) {
                $data['tambah'] = 'tambah';
                $data['error'] = 'error';
                $this->load->view('front/pages/checkout/checkout_kop', $data);
            } else {
