...
<?php $this->load->view('front/slice/menu'); ?>
	...
	<div class="main container">
		...
		<div class="detail-product">
			<div class="image">
				<img src="<?php echo base_url(); ?>include/front/images/product/kop/kop-checkout.png">
			</div>
			<div class="detail">
			<?php echo form_open_multipart('front/checkout/checkout_kop/add', 'id="form_checkout"'); ?>	
				<h3>Kop</h3>
				<p>Tunjukan betapa profesionalnya perusahaan anda dengan memiliki kop surat. Dengan adanya kop surat, klien akan semakin yakin dengan perusahaan anda. </p>
				<div class="selects">
					<div class="items">
						<label>Ukuran</label>
